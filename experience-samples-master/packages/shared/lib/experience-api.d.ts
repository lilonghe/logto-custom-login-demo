    ...
    profile: {
        ...
        socialIdentity?: {
            ...
            userInfo: {
                ...
                rawData?: object | (string | number | boolean | string | null | object)[] | string | number | boolean;
            };
        };
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    experience: {
         ...
         */
        submitInteraction: (params?: RequestParams) => Promise<SubmitInteractionData>;
        /**
         ...
         */
        getInteraction: (params?: RequestParams) => Promise<GetInteractionData>;
        /**
         ...
         */
        createPasswordVerification: (data: {
             ...
             */
            password: string;
        }, params?: RequestParams) => Promise<CreatePasswordVerificationData>;
        /**
         ...
         */
        createAndSendVerificationCode: (data: {
            ...
            interactionEvent: "SignIn" | "Register" | "ForgotPassword";
        }, params?: RequestParams) => Promise<CreateAndSendVerificationCodeData>;
        /**
         ...
         */
        verifyVerificationCodeVerification: (data: {
            ...
            code: string;
        }, params?: RequestParams) => Promise<VerifyVerificationCodeVerificationData>;
        /**
         ...
         */
        createAndSendMfaVerificationCode: (data: {
        ...
        }, params?: RequestParams) => Promise<CreateAndSendMfaVerificationCodeData>;
        /**
        ...
        verifyMfaVerificationCode: (data: {
            ...
            identifierType: "email" | "phone" | "Email" | "Phone";
        }, params?: RequestParams) => Promise<VerifyMfaVerificationCodeData>;
        /**
         ...
         */
        createSocialVerification: (connectorId: string, data: {
            ...
            redirectUri: string;
        }, params?: RequestParams) => Promise<CreateSocialVerificationData>;
        /**
         ...
         */
        verifySocialVerification: (connectorId: string, data: {
            ...
            verificationId?: string;
        }, params?: RequestParams) => Promise<VerifySocialVerificationData>;
        /**
         ...
         */
        createEnterpriseSsoVerification: (connectorId: string, data: {
            /** The state parameter to pass to the SSO connector. */
            state: string;
            /** The URI to redirect the user after the SSO authorization is completed. */
            redirectUri: string;
        }, params?: RequestParams) => Promise<CreateEnterpriseSsoVerificationData>;
        /**
         ...
         */
        verifyEnterpriseSsoVerification: (connectorId: string, data: {
            ...
            verificationId: string;
        }, params?: RequestParams) => Promise<VerifyEnterpriseSsoVerificationData>;
        /**
         ...
         */
        createTotpSecret: (params?: RequestParams) => Promise<CreateTotpSecretData>;
        /**
        ...
        verifyTotpVerification: (data: {
            ...
            verificationId?: string;
        }, params?: RequestParams) => Promise<VerifyTotpVerificationData>;
        /**
         ...
         */
        createWebAuthnRegistrationVerification: (params?: RequestParams) => Promise<CreateWebAuthnRegistrationVerificationData>;
        /**
         ...
         */
        verifyWebAuthnRegistrationVerification: (data: {
        ...
        }, params?: RequestParams) => Promise<VerifyWebAuthnRegistrationVerificationData>;
        /**
         ...
         */
        createWebAuthnAuthenticationVerification: (params?: RequestParams) => Promise<CreateWebAuthnAuthenticationVerificationData>;
        /**
         ...
         */
        verifyWebAuthnAuthenticationVerification: (data: {
        ...
        }, params?: RequestParams) => Promise<VerifyWebAuthnAuthenticationVerificationData>;
        /**
         ...
         */
        generateBackupCodes: (params?: RequestParams) => Promise<GenerateBackupCodesData>;
        /**
        ...
        verifyBackupCode: (data: {
             ...
             */
            code: string;
        }, params?: RequestParams) => Promise<VerifyBackupCodeData>;
        /**
         ...
         */
        createNewPasswordIdentityVerification: (data: {
            ...
            password: string;
        }, params?: RequestParams) => Promise<CreateNewPasswordIdentityVerificationData>;
        /**
         ...
         */
        verifyOneTimeTokenVerification: (data: {
             ...
             */
            token: string;
        }, params?: RequestParams) => Promise<VerifyOneTimeTokenVerificationData>;
        /**
         ...
         */
        skipMfaBindingFlow: (params?: RequestParams) => Promise<any>;
        /**
         ...
         */
        skipMfaSuggestion: (params?: RequestParams) => Promise<any>;
        /**
         ...
         */
        getEnabledSsoConnectors: (query: {
            /**
             * The email address to find the enabled SSO connectors.
             * @format email
             */
            email: string;
        }, params?: RequestParams) => Promise<GetEnabledSsoConnectorsData>;
    };
}
export {};
